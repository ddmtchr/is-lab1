...
public class Coordinates {
    private long x; //Значение поля должно быть больше -527
...
public class Person {
    ...
    private String passportID; //Длина строки не должна быть больше 24, Длина строки должна быть не меньше 7, Строка не может быть пустой, Поле может быть null
...
- Вернуть один (любой) объект, значение поля formOfEducation которого является максимальным.
